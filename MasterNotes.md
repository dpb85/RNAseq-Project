...
Differential gene expression was determined using DEseq2 using [this](https://github.com/dpb85/RNAseq-Project/blob/main/Downstream/calb_DESeq_script_FINAL.R) script in R. 
